...
// ==========================================
console.log("Hallo, mijn naam is " + myName + " ik ben " + myAge + " jaar oud en ben " + myProffesion + "." );
console.log("Ik ben een " + myProffesion + ". ik heb " + eyeColor + " ogen en schoenmaat " + myShoeSize + ".");
console.log("Heeft partner: " + hasPartner + ". Heeft kinderen: " + myChildren);